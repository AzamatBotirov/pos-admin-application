...
import com.mycompany.pos.domain.Product;
...
class ProductResourceIT {
    ...
    private static final ProductType DEFAULT_TYPE = ProductType.KG;
    private static final ProductType UPDATED_TYPE = ProductType.L;

    private static final ProductDirective DEFAULT_DIRECTIVE = ProductDirective.MEVA;
    private static final ProductDirective UPDATED_DIRECTIVE = ProductDirective.SABZAVOT;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getDirective()).isEqualTo(DEFAULT_DIRECTIVE);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].directive").value(hasItem(DEFAULT_DIRECTIVE.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.directive").value(DEFAULT_DIRECTIVE.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).code(UPDATED_CODE).type(UPDATED_TYPE).directive(UPDATED_DIRECTIVE).status(UPDATED_STATUS);
        ...
        assertThat(testProduct.getDirective()).isEqualTo(UPDATED_DIRECTIVE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).code(UPDATED_CODE).type(UPDATED_TYPE).directive(UPDATED_DIRECTIVE).status(UPDATED_STATUS);
